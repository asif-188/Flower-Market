...
const MENU_ITEMS = [
    {
        emoji: '👨‍🌾',
        labelKey: 'farmerMaster',
        color: { border: '#16a34a', text: '#16a34a', bg: '#f0fdf4', glow: 'rgba(22,163,74,0.15)' },
        route: '/app/farmer-master',
    },
    {
        emoji: '💐',
        labelKey: 'flowers',
        color: { border: '#0d9488', text: '#0d9488', bg: '#f0fdfa', glow: 'rgba(13,148,136,0.15)' },
        route: '/app/farmer-flowers',
    },
    {
        emoji: '🌸',
        labelKey: 'farmerPurchase',
        color: { border: '#ea580c', text: '#ea580c', bg: '#fff7ed', glow: 'rgba(234,88,12,0.15)' },
        route: '/app/farmer-purchase',
    },
    {
        emoji: '💵',
        labelKey: 'farmerCashPay',
        color: { border: '#7c3aed', text: '#7c3aed', bg: '#faf5ff', glow: 'rgba(124,58,237,0.15)' },
        route: '/app/farmer-cash-pay',
    },
    {
        emoji: '📄',
        labelKey: 'farmerBillClose',
        color: { border: '#0284c7', text: '#0284c7', bg: '#f0f9ff', glow: 'rgba(2,132,199,0.15)' },
        route: '/app/farmer-bill-close',
    },
    {
        emoji: '📆',
        labelKey: 'farmerMonthReport',
        color: { border: '#db2777', text: '#db2777', bg: '#fdf2f8', glow: 'rgba(219,39,119,0.15)' },
        route: '/app/farmer-month-report',
    },
];
...
const FarmerMenu = () => {
    ...
    // Split into rows: 3 on top, 3 on bottom
